...
export interface PlannerEmptyStateProps {
  onGenerate: () => void;
}

export const PlannerEmptyState: React.FC<PlannerEmptyStateProps> = ({ onGenerate }) => {
  return (
    <div className="p-12 text-center rounded-2xl bg-white border border-slate-200 shadow-sm space-y-4 max-w-lg mx-auto">
      ...
      <div className="space-y-1">
        <h3 className="font-bold text-slate-900 text-base">No Active Plan for Today</h3>
        <p className="text-xs text-slate-500">Generate a personalized adaptive schedule based on your current learning state.</p>
      </div>
