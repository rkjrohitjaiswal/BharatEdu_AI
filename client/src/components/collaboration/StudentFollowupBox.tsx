...
export const StudentFollowupBox: React.FC<Props> = ({ onSend }) => {
  ...
  return (
    <form onSubmit={handleSubmit} className="p-4 bg-slate-900/60 border border-slate-800 rounded-2xl space-y-2">
      <textarea
        ...
        placeholder="Ask teacher a question or report difficulty with task..."
...
export default StudentFollowupBox;
