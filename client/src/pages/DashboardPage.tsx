...
import { LearningEffectivenessCard } from '../components/dashboard/LearningEffectivenessCard';
...
export const DashboardPage: React.FC = () => {
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Feature 44: AI Learning Effectiveness Card */}
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          {/* AI Personalized Practice Engine Card */}
          <PersonalizedPracticeCard />

          {/* AI Exam Simulator Card */}
          <ExamSimulatorCard />

          {/* AI Academic Resource Recommendations Card */}
          <ResourceRecommendationsCard />

          {/* AI Personalized Assessment Engine Card */}
          <AssessmentEngineCard />
