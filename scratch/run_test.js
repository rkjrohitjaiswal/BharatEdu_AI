...
const runTests = async () => {
  ...
  try {
    ...
    console.log('2. Register Student:', regStudent.status === 201 && regStudent.body.token ? '✅ PASS' : '❌ FAIL', regStudent.body.message || regStudent.body);
    ...
    console.log('3. Register Teacher:', regTeacher.status === 201 && regTeacher.body.token ? '✅ PASS' : '❌ FAIL', regTeacher.body.message || regTeacher.body);
